...
def create_parser():
    ...
    parser.add_argument('--ir_psi', type=float, default=0.008, help='ngu memory size')
    parser.add_argument('--ir_max_sim', type=float, default=8, help='ngu memory size')
    parser.add_argument('--ir_buy_in', type=int_type, default=int_type(30), help='ngu memory size')
    # CTRL params
    ...
    parser.add_argument('--ctrl_action_size', type=int_type, default=int_type(8), help='ctrl module latent size')
